...
$$.FutureImpl = {"":
 ...
 transform$1: function(transformation) {
  ...
  this.handleException$1(new $.Closure38(completer));
  this.then$1(new $.Closure39(completer, t1));
...
$$.HashSetImplementation = {"":
 ...
 map$1: function(f) {
  var t1 = ({});
  t1.f_13 = f;
  t1.result_20 = $.HashSetImplementation$0();
  $.forEach(this._backingMap, new $.Closure45(t1));
  return t1.result_20;
 },
 forEach$1: function(f) {
  var t1 = ({});
 ...
 addAll$1: function(collection) {
  $.forEach(collection, new $.Closure47(this));
 },
...
$$.DoubleLinkedQueue = {"":
 ...
 get$first: function() { return new $.Closure53(this, 'first$0'); },
...
$$.ConstantMap = {"":
 ...
 forEach$1: function(f) {
  var t1 = ({});
  t1.f_14 = f;
  $.forEach(this._lib2_keys, new $.Closure48(this, t1));
 },
 operator$index$1: function(key) {
...
$$.FilteredElementList = {"":
 ...
 removeRange$2: function(start, rangeLength) {
  $.forEach($.getRange(this.get$_filtered(), start, rangeLength), new $.Closure46());
 },
 addLast$1: function(value) {
  this.add$1(value);
 },
 ...
 get$add: function() { return new $.Closure56(this, 'add$1'); },
 set$length: function(newLength) {
  var len = $.get$length(this);
  if ($.geB(newLength, len)) return;
  if ($.ltB(newLength, 0)) throw $.captureStackTrace($.CTC10);
 ...
 get$_filtered: function() {
  return $.List$from($.filter(this._childNodes, new $.Closure43()));
 },
...
$$._ChildrenElementList = {"":
 ...
 filter$1: function(f) {
  ...
  t1.f_12 = f;
  var output = [];
  this.forEach$1(new $.Closure42(t1, output));
...
$$.Sprite = {"":
 ["spriteHeight", "spriteWidth", "startY", "startX", "image?"],
 super: "Object",
 draw$5: function(context, drawX, drawY, drawWidth, drawHeight) {
  if ($.eqNullB(drawWidth)) drawWidth = this.spriteWidth;
  if ($.eqNullB(drawHeight)) drawHeight = this.spriteHeight;
  context.drawImage$9(this.image, this.startX, this.startY, this.spriteWidth, this.spriteHeight, drawX, drawY, drawWidth, drawHeight);
 },
 draw$3: function(context,drawX,drawY) {
  return this.draw$5(context,drawX,drawY,null,null)
},
 Sprite$5: function(image, startX, startY, spriteWidth, spriteHeight) {
 },
 Sprite$fullSize$1: function(image) {
  this.startX = 0;
  this.startY = 0;
  var t1 = this.image;
  this.spriteWidth = t1.get$width();
  this.spriteHeight = t1.get$height();
 }
};
...
$$.Xorshift = {"":
 ...
 random$0: function() {
  var r = this.xor128$0();
  var t1 = this.min;
  return $.add($.mod($.add(t1, r), this.max), t1);
 },
 xor128$0: function() {
  var t = $.xor($.x, $.shl($.x, 11));
  $.x = $.y;
  $.y = $.z;
  $.z = $.w;
  $.w = $.xor($.xor($.w, $.shr($.w, 19)), $.xor(t, $.shr(t, 8)));
  return $.w;
 }
};

$$.GameEventListenerList = {"":
 ["_lib0_type", "_lib0_ptr"],
 super: "Object",
 remove$2: function(callback, useCapture) {
  this._lib0_ptr.removeEventListener$3(this._lib0_type, callback, useCapture);
  return this;
 },
 remove$1: function(callback) {
  return this.remove$2(callback,null)
},
 add$2: function(callback, useCapture) {
  this._lib0_ptr.addEventListener$3(this._lib0_type, callback, useCapture);
  return this;
 },
 add$1: function(callback) {
  return this.add$2(callback,null)
}
};
...
$$.GameEvents = {"":
 ...
 super: "Object",
 get$keyPress: function() {
  return $.GameEventListenerList$2(this._lib0_ptr, 'keyPress');
 },
 get$keyUp: function() {
  return $.GameEventListenerList$2(this._lib0_ptr, 'keyUp');
 },
 get$keyDown: function() {
  return $.GameEventListenerList$2(this._lib0_ptr, 'keyDown');
 },
 get$click: function() {
  return $.GameEventListenerList$2(this._lib0_ptr, 'click');
 },
 get$mouseUp: function() {
  return $.GameEventListenerList$2(this._lib0_ptr, 'mouseUp');
 },
 get$mouseDown: function() {
  return $.GameEventListenerList$2(this._lib0_ptr, 'mouseDown');
 },
 get$mouseMove: function() {
  return $.GameEventListenerList$2(this._lib0_ptr, 'mouseOut');
 },
 get$mouseOut: function() {
  return $.GameEventListenerList$2(this._lib0_ptr, 'mouseOut');
 },
 get$mouseOver: function() {
  return $.GameEventListenerList$2(this._lib0_ptr, 'mouseOver');
 },
 get$unload: function() {
  return $.GameEventListenerList$2(this._lib0_ptr, 'unload');
 },
 get$load: function() {
  return $.GameEventListenerList$2(this._lib0_ptr, 'load');
 }
};

$$.GameEvent = {"":
 ["currentTarget!", "target?", "eventPhase=", "type="],
 super: "Object"
};

$$.GameMouseEvent = {"":
 ["shiftKey?", "metaKey?", "ctrlKey?", "altKey?", "pmouseY?", "pmouseX?", "mouseY?", "mouseX?", "button?", "currentTarget", "target", "eventPhase", "type"],
 super: "GameEvent",
 is$GameMouseEvent: true
};

$$.GameKeyboardEvent = {"":
 ["keyLocation?", "keyIdentifier?", "shiftKey?", "metaKey?", "ctrlKey?", "altKey?", "altGraphKey?", "currentTarget", "target", "eventPhase", "type"],
 super: "GameEvent"
};

$$.GameNode = {"":
 ["parent=", "children=", "bubblingListeners?", "capturingListeners?"],
 super: "Object",
 appendChild$1: function(node) {
  $.add$1(this.get$children(), node);
  node.set$parent(this);
  return node;
 },
 replaceWith$1: function(node) {
  var t1 = ({});
  t1.node_10 = node;
  var t2 = $.map(this.get$parent().get$children(), new $.Closure44(this, t1));
  this.get$parent().set$children(t2);
  this.set$parent(null);
  return this;
 },
 remove$0: function() {
  var t1 = $.filter(this.get$parent().get$children(), new $.Closure13(this));
  this.get$parent().set$children(t1);
  this.set$parent(null);
  return this;
 },
 contains$1: function(node) {
  var t1 = ({});
  t1.node_1 = node;
  return $.some(this.get$children(), new $.Closure12(this, t1));
 },
 callEventListener$1: function(evt) {
  var t1 = ({});
  t1.evt_1 = evt;
  var t2 = t1.evt_1;
  if (typeof t2 === 'object' && t2 !== null && !!t2.is$GameMouseEvent) {
    if ($.eqB(t1.evt_1.get$type(), 'mouseOut')) {
      t2 = this.hasPoint$2(t1.evt_1.get$mouseX(), t1.evt_1.get$mouseY()) === true || this.hasPoint$2(t1.evt_1.get$pmouseX(), t1.evt_1.get$pmouseY()) !== true;
    } else t2 = false;
    if (t2) return;
    if (this.hasPoint$2(t1.evt_1.get$mouseX(), t1.evt_1.get$mouseY()) !== true) return;
  }
  switch (t1.evt_1.get$eventPhase()) {
    case 1:
      $.forEach($.index(this.capturingListeners, t1.evt_1.get$type()), new $.Closure7(t1));
      break;
    case 2:
    case 3:
      $.forEach($.index(this.bubblingListeners, t1.evt_1.get$type()), new $.Closure8(t1));
      break;
  }
 },
 removeEventListener$3: function(type, callback, useCapture) {
  if (useCapture === true) $.index(this.capturingListeners, type).remove$1(callback);
  else $.index(this.bubblingListeners, type).remove$1(callback);
 },
 addEventListener$3: function(type, callback, useCapture) {
  var t1 = useCapture === true;
  if (t1) $.add$1($.index(this.capturingListeners, type), callback);
  else {
    !t1 && $.add$1($.index(this.bubblingListeners, type), callback);
  }
 },
 get$on: function() {
  return $.GameEvents$1(this);
 },
 GameNode$0: function() {
  var eventNames = ['load', 'unLoad', 'mouseOver', 'mouseOut', 'mouseMove', 'mouseDown', 'mouseUp', 'click', 'doubleClick', 'keyDown', 'keyUp', 'keyPress'];
  this.capturingListeners = $.makeLiteralMap([]);
  $.forEach(eventNames, new $.Closure16(this));
  this.bubblingListeners = $.makeLiteralMap([]);
  $.forEach(eventNames, new $.Closure17(this));
  this.set$children([]);
 }
};

$$.Game = {"":
 ["_height", "_width", "audios?", "images?", "preloadAudios=", "preloadImages!", "pmouseY?", "pmouseX?", "mouseY?", "mouseX?", "fps=", "context?", "canvas?", "lib0$Game$children=", "parent", "children", "bubblingListeners", "capturingListeners"],
 super: "GameNode",
 loadScene$1: function(scene) {
  !$.eqNullB(this.get$currentScene()) && this.get$currentScene().callEventListener$1($.GameEvent$4('unLoad', 2, this.get$currentScene(), this.get$currentScene()));
  $.indexSet(this.lib0$Game$children, 0, scene);
  scene.set$parent(this);
  scene.callEventListener$1($.GameEvent$4('load', 2, scene, scene));
 },
 start$0: function() {
  var t1 = ({});
  t1.timerID_1 = null;
  t1.i_2 = 0;
  for (var t2 = $.iterator(this.preloadImages); t2.hasNext$0() === true; ) {
    var t3 = t2.next$0();
    var item = $.ImageElement(null, null, null);
    t1.i_2 = $.add(t1.i_2, 1);
    $.add$1(item.get$on().get$load(), new $.Closure0(t1));
    item.set$src(t3);
    $.indexSet(this.images, t3, $.Sprite$fullSize$1(item));
  }
  for (t2 = $.iterator(this.preloadAudios); t2.hasNext$0() === true; ) {
    t3 = t2.next$0();
    item = $.AudioElement(null);
    $.add$1(item.get$on().get$load(), new $.Closure1(t1));
    item.set$src(t3);
    $.indexSet(this.audios, t3, item);
  }
  t1.timerID_1 = $.window().setInterval$2(new $.Closure2(this, t1), 33);
 },
 animate$1: function(callback) {
  var t1 = ({});
  t1.callback_1 = callback;
  var frameCallback = new $.Closure28(this, t1);
  t1.timerID_20 = $.window().requestAnimationFrame$1(frameCallback);
  return new $.Closure29(t1);
 },
 size$2: function(w, h) {
  this.set$width(w);
  this.set$height(h);
 },
 _onKeyPress$1: function(evt) {
  return this._onKeyboard$2('keyPress', evt);
 },
 get$_onKeyPress: function() { return new $.Closure56(this, '_onKeyPress$1'); },
 _onKeyUp$1: function(evt) {
  return this._onKeyboard$2('keyUp', evt);
 },
 get$_onKeyUp: function() { return new $.Closure56(this, '_onKeyUp$1'); },
 _onKeyDown$1: function(evt) {
  return this._onKeyboard$2('keyDown', evt);
 },
 get$_onKeyDown: function() { return new $.Closure56(this, '_onKeyDown$1'); },
 _onKeyboard$2: function(type, evt) {
  var gameEvent = $.GameKeyboardEvent$fromEvent$5(type, 1, this.get$currentScene(), this, evt);
  this.callEventListener$1(gameEvent);
  gameEvent.currentTarget = this.get$currentScene();
  this.get$currentScene().callEventListener$1(gameEvent);
 },
 _onDoubleClick$1: function(evt) {
  return this._onMouse$2('doubleClick', evt);
 },
 get$_onDoubleClick: function() { return new $.Closure56(this, '_onDoubleClick$1'); },
 _onClick$1: function(evt) {
  return this._onMouse$2('click', evt);
 },
 get$_onClick: function() { return new $.Closure56(this, '_onClick$1'); },
 _onMouseUp$1: function(evt) {
  return this._onMouse$2('mouseUp', evt);
 },
 get$_onMouseUp: function() { return new $.Closure56(this, '_onMouseUp$1'); },
 _onMouseDown$1: function(evt) {
  return this._onMouse$2('mouseDown', evt);
 },
 get$_onMouseDown: function() { return new $.Closure56(this, '_onMouseDown$1'); },
 _onMouseOut$1: function(evt) {
  this.pmouseX = this.mouseX;
  this.pmouseY = this.mouseY;
  var gameEvent = $.GameMouseEvent$fromEvent$9('mouseOut', 1, this.get$currentScene(), this, this.mouseX, this.mouseY, this.pmouseX, this.pmouseY, evt);
  this.callEventListener$1(gameEvent);
  gameEvent.currentTarget = this.get$currentScene();
  this.get$currentScene().callEventListener$1(gameEvent);
 },
 get$_onMouseOut: function() { return new $.Closure56(this, '_onMouseOut$1'); },
 _onMouseMove$1: function(evt) {
  var t1 = ({});
  t1.callChain_1 = null;
  this._getMousePoint$1(evt);
  t1.chain_2 = [];
  t1.gameEvent_3 = $.GameMouseEvent$fromEvent$9('mouseMove', 1, $.last(this._detectEndNodeFromPoint$2(this.mouseX, this.mouseY)), this, this.mouseX, this.mouseY, this.pmouseX, this.pmouseY, evt);
  this.callEventListener$1(t1.gameEvent_3);
  t1.callChain_1 = new $.Closure11(this, t1);
  $.forEach(this.lib0$Game$children, t1.callChain_1);
 },
 get$_onMouseMove: function() { return new $.Closure56(this, '_onMouseMove$1'); },
 _onMouseOver$1: function(evt) {
  return this._onMouse$2('mouseOver', evt);
 },
 get$_onMouseOver: function() { return new $.Closure56(this, '_onMouseOver$1'); },
 _onMouse$2: function(type, evt) {
  var t1 = ({});
  this._getMousePoint$1(evt);
  var chain = this._detectEndNodeFromPoint$2(this.mouseX, this.mouseY);
  if (typeof chain !== 'string' && (typeof chain !== 'object' || chain === null || (chain.constructor !== Array && !chain.is$JavaScriptIndexingBehavior()))) return this._onMouse$2$bailout(1, type, evt, t1, chain);
  t1.gameEvent_1 = $.GameMouseEvent$fromEvent$9(type, 1, $.last(chain), this, this.mouseX, this.mouseY, this.pmouseX, this.pmouseY, evt);
  this.callEventListener$1(t1.gameEvent_1);
  $.forEach(chain, new $.Closure9(t1));
  t1.gameEvent_1.set$eventPhase(3);
  for (var i = chain.length - 2; i >= 0; --i) {
    var t2 = chain.length;
    if (i < 0 || i >= t2) throw $.ioore(i);
    var t3 = chain[i];
    t1.gameEvent_1.set$currentTarget(t3);
    t3.callEventListener$1(t1.gameEvent_1);
  }
 },
 _onMouse$2$bailout: function(state, type, evt, t1, chain) {
  t1.gameEvent_1 = $.GameMouseEvent$fromEvent$9(type, 1, $.last(chain), this, this.mouseX, this.mouseY, this.pmouseX, this.pmouseY, evt);
  this.callEventListener$1(t1.gameEvent_1);
  $.forEach(chain, new $.Closure9(t1));
  t1.gameEvent_1.set$eventPhase(3);
  for (var i = $.sub($.get$length(chain), 2); $.geB(i, 0); i = $.sub(i, 1)) {
    var node = $.index(chain, i);
    t1.gameEvent_1.set$currentTarget(node);
    node.callEventListener$1(t1.gameEvent_1);
  }
 },
 _detectEndNodeFromPoint$2: function(x, y) {
  var t1 = ({});
  t1.y_2 = y;
  t1.x_1 = x;
  t1.callChain_3 = null;
  t1.chain_4 = [this.get$currentScene()];
  t1.callChain_3 = new $.Closure10(t1);
  $.forEach(this.get$currentScene().get$children(), t1.callChain_3);
  return t1.chain_4;
 },
 _getMousePoint$1: function(evt) {
  this.pmouseX = this.mouseX;
  this.pmouseY = this.mouseY;
  this.mouseX = evt.get$layerX();
  this.mouseY = evt.get$layerY();
 },
 hasPoint$2: function(x, y) {
  return true;
 },
 get$currentScene: function() {
  return $.index(this.lib0$Game$children, 0);
 },
 set$height: function(h) {
  this.canvas.set$height(h);
  this._height = h;
 },
 get$height: function() {
  return this._height;
 },
 set$width: function(w) {
  this.canvas.set$width(w);
  this._width = w;
 },
 get$width: function() {
  return this._width;
 ...
 get$children: function() {
  return this.lib0$Game$children;
 },
 set$children: function(x) {
  this.lib0$Game$children = x;
 },
 Game$1: function(canvasArg) {
  this.lib0$Game$children = [];
  this.preloadImages = [];
  this.preloadAudios = [];
  this.images = $.makeLiteralMap([]);
  this.audios = $.makeLiteralMap([]);
 },
 is$Game: true
};

$$.Scene = {"":
 ["stopSceneAnimation!", "lib0$Scene$parent=", "lib0$Scene$children="],
 super: "GameNode",
 stopSceneAnimation$0: function() { return this.stopSceneAnimation.$call$0(); },
 hasPoint$2: function(x, y) {
  return true;
 },
 get$parent: function() {
  return this.lib0$Scene$parent;
 },
 set$parent: function(x) {
  this.lib0$Scene$parent = x;
 },
 get$children: function() {
  return this.lib0$Scene$children;
 },
 set$children: function(x) {
  this.lib0$Scene$children = x;
 },
 Scene$0: function() {
  $.add$1(this.get$on().get$load(), new $.Closure49(this));
  $.add$1(this.get$on().get$unload(), new $.Closure50(this));
 }
};

$$.GameEntity = {"":
 ["lib0$GameEntity$children="],
 super: "GameNode",
 get$game: function() {
  var node = this.parent;
  for (; !((typeof node === 'object' && node !== null) && !!node.is$Game); ) {
    node = node.get$parent();
  }
  return node;
 },
 get$children: function() {
  return this.lib0$GameEntity$children;
 },
 set$children: function(x) {
  this.lib0$GameEntity$children = x;
 }
};

$$.Shape = {"":
 ["lineJoin!", "strokeStyle!", "fillStyle!", "lineWidth!"],
 super: "GameEntity"
};

$$.ShapeRect = {"":
 ["height=", "width=", "startY", "startX", "lineJoin", "strokeStyle", "fillStyle", "lineWidth", "lib0$GameEntity$children", "parent", "children", "bubblingListeners", "capturingListeners"],
 super: "Shape",
 draw$0: function() {
  var context = this.get$game().get$context();
  !$.eqNullB(this.lineWidth) && context.set$lineWidth(this.lineWidth);
  !$.eqNullB(this.fillStyle) && context.set$fillStyle(this.fillStyle);
  !$.eqNullB(this.strokeStyle) && context.set$strokeStyle(this.strokeStyle);
  !$.eqNullB(this.lineJoin) && context.set$lineJoin(this.lineJoin);
  context.fillRect$4(this.startX, this.startY, this.width, this.height);
 },
 hasPoint$2: function(x, y) {
  var t1 = this.startX;
  if ($.leB(t1, x) && $.leB(x, $.add(t1, this.width))) {
    t1 = this.startY;
    t1 = $.leB(t1, y) && $.leB(y, $.add(t1, this.height));
  } else t1 = false;
  return t1;
 }
};
...
$$.ShapeText = {"":
 ["textBaseline!", "textAlign!", "font!", "text!", "maxWidth", "startY", "startX", "lineJoin", "strokeStyle", "fillStyle", "lineWidth", "lib0$GameEntity$children", "parent", "children", "bubblingListeners", "capturingListeners"],
 super: "Shape",
 draw$0: function() {
  var context = this.get$game().get$context();
  !$.eqNullB(this.font) && context.set$font(this.font);
  !$.eqNullB(this.textAlign) && context.set$textAlign(this.textAlign);
  !$.eqNullB(this.textBaseline) && context.set$textBaseline(this.textBaseline);
  !$.eqNullB(this.fillStyle) && context.set$fillStyle(this.fillStyle);
  this.get$game().get$context().fillText$4(this.text, this.startX, this.startY, this.maxWidth);
 },
 hasPoint$2: function(x, y) {
  var t1 = this.startX;
  if ($.leB(t1, x) && $.leB(x, $.add(t1, this.get$width()))) {
    t1 = this.startY;
    t1 = $.leB(t1, y) && $.leB(y, $.add(t1, this.get$game().get$context().get$fontSize()));
  } else t1 = false;
  return t1;
 },
 get$height: function() {
  var node = $.Element$html('<div>' + $.S(this.text) + '</div>');
  var t1 = this.font;
  node.get$style().set$font(t1);
  return node.get$computedStyle().transform$1(new $.Closure37());
 },
 get$width: function() {
  var t1 = this.maxWidth;
  return !(t1 == null) ? t1 : this.get$game().get$context().measureText$1(this.text).get$width();
 }
};

$$.FirstScene = {"":
 ["startText", "rect?", "stopSceneAnimation", "lib0$Scene$parent", "lib0$Scene$children", "parent", "children", "bubblingListeners", "capturingListeners"],
 super: "Scene",
 onUnLoad$0: function() {
  this.lib0$Scene$parent.get$context().clearRect$4(0, 0, this.lib0$Scene$parent.get$width(), this.lib0$Scene$parent.get$height());
 },
 get$onUnLoad: function() { return new $.Closure53(this, 'onUnLoad$0'); },
 onLoad$0: function() {
  this.rect = $.ShapeRect$4(0, 0, this.lib0$Scene$parent.get$width(), this.lib0$Scene$parent.get$height());
  this.startText = $.ShapeText$4('Start', $.tdiv(this.lib0$Scene$parent.get$width(), 2), $.tdiv(this.lib0$Scene$parent.get$height(), 2), '60px sans-serif');
  this.rect.set$fillStyle('orange');
  $.add$1(this.rect.get$on().get$mouseOver(), this.get$rectOnMouseOver());
  $.add$1(this.rect.get$on().get$mouseOut(), this.get$rectOnMouseOut());
  $.add$1(this.rect.get$on().get$click(), this.get$rectOnClick());
  this.startText.set$fillStyle('white');
  this.startText.set$textAlign('center');
  this.appendChild$1(this.rect);
  this.appendChild$1(this.startText);
 },
 get$onLoad: function() { return new $.Closure53(this, 'onLoad$0'); },
 rectOnClick$1: function(evt) {
  var t1 = ({});
  t1.v_1 = 0;
  t1.timerID_2 = null;
  this.rect.get$on().get$mouseOver().remove$1(this.get$rectOnMouseOver());
  this.rect.get$on().get$mouseOut().remove$1(this.get$rectOnMouseOut());
  var t2 = $.window();
  var t3 = new $.Closure23(this, t1);
  var t4 = this.lib0$Scene$parent.get$fps();
  if (typeof t4 !== 'number') throw $.iae(t4);
  t1.timerID_2 = t2.setInterval$2(t3, $.tdiv(1000, t4));
 },
 get$rectOnClick: function() { return new $.Closure56(this, 'rectOnClick$1'); },
 rectOnMouseOut$1: function(evt) {
  this.rect.set$fillStyle('orange');
  return 'orange';
 },
 get$rectOnMouseOut: function() { return new $.Closure56(this, 'rectOnMouseOut$1'); },
 rectOnMouseOver$1: function(evt) {
  this.rect.set$fillStyle('red');
  return 'red';
 },
 get$rectOnMouseOver: function() { return new $.Closure56(this, 'rectOnMouseOver$1'); },
 FirstScene$0: function() {
  $.add$1(this.get$on().get$load(), this.get$onLoad());
  $.add$1(this.get$on().get$unload(), this.get$onUnLoad());
 }
};

$$.MainScene = {"":
 ["momongaOnClickHandler", "killOnClickHandler", "bakeOnClickHandler", "momongaFaces", "dieFaces", "liveFaces", "xor800", "xor600", "faceSprites?", "stop", "stopSceneAnimation", "lib0$Scene$parent", "lib0$Scene$children", "parent", "children", "bubblingListeners", "capturingListeners"],
 super: "Scene",
 drawFaces$0: function() {
  $.forEach(this.liveFaces, new $.Closure33(this));
  $.forEach(this.dieFaces, new $.Closure34(this));
  $.forEach(this.momongaFaces, new $.Closure35(this));
 },
 momongaOnClick$1: function(evt) {
  $.add$1(this.momongaFaces, $.Face$3('momonga', this.xor800.random$0(), this.xor600.random$0()));
 },
 get$momongaOnClick: function() { return new $.Closure56(this, 'momongaOnClick$1'); },
 killOnClick$1: function(evt) {
  var t1 = ({});
  if ($.isEmpty(this.liveFaces) !== true) {
    t1.killedFace_1 = $.index(this.liveFaces, $.toInt($.mul($.random(), $.get$length(this.liveFaces))));
    this.liveFaces = $.filter(this.liveFaces, new $.Closure36(t1));
    $.add$1(this.dieFaces, $.Face$3('die', t1.killedFace_1.get$x(), t1.killedFace_1.get$y()));
  }
 },
 get$killOnClick: function() { return new $.Closure56(this, 'killOnClick$1'); },
 bakeOnClick$1: function(evt) {
  $.add$1(this.liveFaces, $.Face$3('live', $.toInt($.mul($.random(), 800)), $.toInt($.mul($.random(), 600))));
 },
 get$bakeOnClick: function() { return new $.Closure56(this, 'bakeOnClick$1'); },
 after$0: function() {
  this.stop$0();
  $.query('#bakeButton').get$on().get$click().remove$1(this.bakeOnClickHandler);
  $.query('#killButton').get$on().get$click().remove$1(this.killOnClickHandler);
  $.query('#momongaButton').get$on().get$click().remove$1(this.momongaOnClickHandler);
 },
 get$after: function() { return new $.Closure53(this, 'after$0'); },
 onload$0: function() {
  $.add$1($.query('#bakeButton').get$on().get$click(), this.bakeOnClickHandler);
  $.add$1($.query('#killButton').get$on().get$click(), this.killOnClickHandler);
  $.add$1($.query('#momongaButton').get$on().get$click(), this.momongaOnClickHandler);
  var audioIdx = $.mod($.DateImplementation$now$0().get$millisecond(), $.get$length(this.lib0$Scene$parent.get$audios().getKeys$0()));
  $.index(this.lib0$Scene$parent.get$audios(), $.index(this.lib0$Scene$parent.get$preloadAudios(), audioIdx)).play$0();
  var image = $.index(this.lib0$Scene$parent.get$images(), 'images/image.png').get$image();
  this.faceSprites = $.makeLiteralMap(['live', $.Sprite$5(image, 0, 0, 16, 16), 'die', $.Sprite$5(image, 16, 0, 16, 16), 'momonga', $.Sprite$5(image, 32, 0, 16, 25)]);
  this.liveFaces = [];
  this.dieFaces = [];
  this.momongaFaces = [];
  this.lib0$Scene$parent.animate$1(new $.Closure27(this));
 },
 get$onload: function() { return new $.Closure53(this, 'onload$0'); },
 stop$0: function() { return this.stop.$call$0(); },
 MainScene$0: function() {
  this.bakeOnClickHandler = this.get$bakeOnClick();
  this.killOnClickHandler = this.get$killOnClick();
  this.momongaOnClickHandler = this.get$momongaOnClick();
  this.xor600 = $.Xorshift$minmax$2(0, 600);
  this.xor800 = $.Xorshift$minmax$2(0, 800);
  $.add$1(this.get$on().get$load(), this.get$onload());
  $.add$1(this.get$on().get$unload(), this.get$after());
 }
};
...
$$.Face = {"":
 ...
 Face$3: function(type, x, y) {
  if ($.eqNullB($.xor1)) $.xor1 = $.Xorshift$minmax$2(0, 1000);
 }
};
...
$$.Closure = {"":
 ...
 super: "Closure54",
 $call$1: function(evt) {
  return $.game.loadScene$1($.FirstScene$0());
 }
};
...
$$.Closure2 = {"":
 ...
 super: "Closure54",
 $call$0: function() {
  if ($.leB(this.box_0.i_2, 0)) {
    $.window().clearInterval$1(this.box_0.timerID_1);
    $.add$1(this.this_3.get$canvas().get$on().get$mouseOver(), this.this_3.get$_onMouseOver());
    $.add$1(this.this_3.get$canvas().get$on().get$mouseMove(), this.this_3.get$_onMouseMove());
    $.add$1(this.this_3.get$canvas().get$on().get$mouseOut(), this.this_3.get$_onMouseOut());
    $.add$1(this.this_3.get$canvas().get$on().get$mouseDown(), this.this_3.get$_onMouseDown());
    $.add$1(this.this_3.get$canvas().get$on().get$mouseUp(), this.this_3.get$_onMouseUp());
    $.add$1(this.this_3.get$canvas().get$on().get$click(), this.this_3.get$_onClick());
    $.add$1(this.this_3.get$canvas().get$on().get$doubleClick(), this.this_3.get$_onDoubleClick());
    $.add$1($.document().get$on().get$keyDown(), this.this_3.get$_onKeyDown());
    $.add$1($.document().get$on().get$keyUp(), this.this_3.get$_onKeyUp());
    $.add$1($.document().get$on().get$keyPress(), this.this_3.get$_onKeyPress());
    var t1 = this.this_3;
    t1.callEventListener$1($.GameEvent$4('load', 2, t1, t1));
  }
 }
};
...
$$.Closure7 = {"":
 ...
 $call$1: function(listener) {
  return listener.$call$1(this.box_0.evt_1);
 }
};
...
$$.Closure9 = {"":
 ...
 $call$1: function(node) {
  this.box_0.gameEvent_1.set$currentTarget(node);
  $.eqB(node, this.box_0.gameEvent_1.get$target()) && this.box_0.gameEvent_1.set$eventPhase(2);
  node.callEventListener$1(this.box_0.gameEvent_1);
 }
};
...
$$.Closure10 = {"":
 ...
 $call$1: function(node) {
  var t1 = this.box_0;
  if (node.hasPoint$2(t1.x_1, t1.y_2) === true) {
    $.add$1(this.box_0.chain_4, node);
    $.forEach(node.get$children(), this.box_0.callChain_3.$call$1(node));
  }
 }
};
...
$$.Closure11 = {"":
 ...
 super: "Closure54",
 $call$1: function(node) {
  if (node.hasPoint$2(this.this_4.get$pmouseX(), this.this_4.get$pmouseY()) !== true && node.hasPoint$2(this.this_4.get$mouseX(), this.this_4.get$mouseY()) === true) {
    this.box_0.gameEvent_3.set$currentTarget(node);
    this.box_0.gameEvent_3.set$type('mouseOn');
    node.callEventListener$1(this.box_0.gameEvent_3);
    $.add$1(this.box_0.chain_2, node);
    $.forEach(node.get$children(), this.box_0.callChain_1);
  } else {
    if (node.hasPoint$2(this.this_4.get$pmouseX(), this.this_4.get$pmouseY()) === true && node.hasPoint$2(this.this_4.get$mouseX(), this.this_4.get$mouseY()) !== true) {
      this.box_0.gameEvent_3.set$currentTarget(node);
      this.box_0.gameEvent_3.set$type('mouseOut');
      node.callEventListener$1(this.box_0.gameEvent_3);
      $.add$1(this.box_0.chain_2, node);
      $.forEach(node.get$children(), this.box_0.callChain_1);
    } else {
      if (node.hasPoint$2(this.this_4.get$mouseX(), this.this_4.get$mouseY()) === true) {
        this.box_0.gameEvent_3.set$currentTarget(node);
        this.box_0.gameEvent_3.set$type('mouseMove');
        node.callEventListener$1(this.box_0.gameEvent_3);
        $.add$1(this.box_0.chain_2, node);
        $.forEach(node.get$children(), this.box_0.callChain_1);
      }
...
$$.Closure12 = {"":
 ...
 $call$1: function(child) {
  return $.eqB(child.get$parent(), this.this_2) && $.eqB(child, this.box_0.node_1);
 }
};
...
$$.Closure16 = {"":
 ...
 $call$1: function(eventName) {
  var t1 = this.this_0.get$capturingListeners();
  var t2 = $.HashSetImplementation$0();
  $.indexSet(t1, eventName, t2);
  return t2;
 }
};
...
$$.Closure17 = {"":
 ...
 super: "Closure54",
 $call$1: function(eventName) {
  var t1 = this.this_1.get$bubblingListeners();
  var t2 = $.HashSetImplementation$0();
  $.indexSet(t1, eventName, t2);
  return t2;
 }
...
$$.Closure23 = {"":
 ...
 super: "Closure54",
 $call$0: function() {
  if ($.geB(this.box_0.v_1, 255)) {
    $.window().clearInterval$1(this.box_0.timerID_2);
    this.this_3.get$parent().loadScene$1($.MainScene$0());
  } else {
    var t1 = 'rgb(255, ' + $.S(this.box_0.v_1) + ', ' + $.S(this.box_0.v_1) + ')';
    this.this_3.get$rect().set$fillStyle(t1);
    var v = $.add(this.box_0.v_1, 8);
    this.box_0.v_1 = v;
  }
 }
};
...
$$.Closure27 = {"":
 ...
 super: "Closure54",
 $call$0: function() {
  return this.this_0.drawFaces$0();
 }
};
...
$$.Closure28 = {"":
 ...
 super: "Closure54",
 $call$0: function() {
  this.this_3.get$context().clearRect$4(0, 0, this.this_3.get$width(), this.this_3.get$height());
...
$$.Closure29 = {"":
 ...
 super: "Closure54",
 $call$0: function() {
  return $.window().cancelAnimationFrame$1(this.box_0.timerID_20);
 }
};
...
$$.Closure33 = {"":
 ...
 $call$1: function(face) {
  face.move$0();
  $.index(this.this_0.get$faceSprites(), 'live').draw$3(this.this_0.get$parent().get$context(), face.get$x(), face.get$y());
 }
};
...
$$.Closure34 = {"":
 ...
 super: "Closure54",
 $call$1: function(face) {
  return $.index(this.this_1.get$faceSprites(), 'die').draw$3(this.this_1.get$parent().get$context(), face.get$x(), face.get$y());
 }
};
...
$$.Closure35 = {"":
 ...
 $call$1: function(face) {
  face.move$0();
  $.index(this.this_2.get$faceSprites(), 'momonga').draw$3(this.this_2.get$parent().get$context(), face.get$x(), face.get$y());
 }
};
...
$$.Closure36 = {"":
 ...
 super: "Closure54",
 $call$1: function(elm) {
  return !$.eqB(elm, this.box_0.killedFace_1);
 }
};
...
$$.Closure37 = {"":
 ...
 $call$1: function(style) {
  return $.FutureImpl$immediate(style.get$height());
 }
};
...
$$.Closure40 = {"":
 ...
 super: "Closure54",
 $call$0: function() {
  return $._window().$dom_getComputedStyle$2(this.this_2, this.box_0.pseudoElement_1);
 }
};
...
$$.Closure42 = {"":
 ...
 super: "Closure54",
 $call$1: function(element) {
  this.box_0.f_12.$call$1(element) === true && $.add$1(this.output_2, element);
 }
};
...
$$.Closure44 = {"":
 ...
 super: "Closure54",
 $call$1: function(child) {
  if ($.eqB(child, this.this_2)) return this.box_0.node_10;
  return child;
 }
};
...
$$.Closure45 = {"":
 ...
 $call$2: function(key, value) {
  var t1 = this.box_0;
  $.add$1(t1.result_20, t1.f_13.$call$1(key));
 }
};
...
$$.Closure49 = {"":
 ...
 super: "Closure54",
 $call$1: function(evt) {
  var t1 = this.this_0.get$parent().animate$1(new $.Closure51(this.this_0));
  this.this_0.set$stopSceneAnimation(t1);
 }
};
...
$$.Closure51 = {"":
 ...
 super: "Closure54",
 $call$0: function() {
  return $.forEach(this.this_1.get$children(), new $.Closure52());
 }
};
...
$$.Closure50 = {"":
 ...
 super: "Closure54",
 $call$1: function(evt) {
  return this.this_2.stopSceneAnimation$0();
 }
};
...
Isolate.$defineClass('Closure53', 'Closure54', ['self', 'target'], {
$call$0: function() { return this.self[this.target](); }
});
Isolate.$defineClass('Closure55', 'Closure54', ['self', 'target'], {
$call$4: function(p0, p1, p2, p3) { return this.self[this.target](p0, p1, p2, p3); }
});
Isolate.$defineClass('Closure56', 'Closure54', ['self', 'target'], {
...
$.GameEventListenerList$2 = function(_ptr, _type) {
  return new $.GameEventListenerList(_type, _ptr);
};
...
$.GameEvents$1 = function(_ptr) {
  return new $.GameEvents(_ptr);
};
...
$.GameMouseEvent$fromEvent$9 = function(type, eventPhase, target, currentTarget, mouseX, mouseY, pmouseX, pmouseY, event$) {
  var t1 = event$.get$button();
  var t2 = event$.get$altKey();
  var t3 = event$.get$ctrlKey();
  var t4 = event$.get$metaKey();
  return new $.GameMouseEvent(event$.get$metaKey(), t4, t3, t2, pmouseY, pmouseX, mouseY, mouseX, t1, currentTarget, target, eventPhase, type);
};
...
$.Sprite$fullSize$1 = function(image) {
  var t1 = new $.Sprite(null, null, null, null, image);
  t1.Sprite$fullSize$1(image);
  return t1;
};
...
$._maybeScheduleMeasurementFrame = function() {
  ...
  if ($._firstMeasurementRequest === true) {
    $.add$1($.window().get$on().get$message(), new $.Closure25());
...
$.ShapeRect$4 = function(startX, startY, width, height) {
  var t1 = new $.ShapeRect(height, width, startY, startX, null, null, null, null, null, null, null, null, null);
  t1.GameNode$0();
  return t1;
};
...
$.Sprite$5 = function(image, startX, startY, spriteWidth, spriteHeight) {
  var t1 = new $.Sprite(spriteHeight, spriteWidth, startY, startX, image);
  t1.Sprite$5(image, startX, startY, spriteWidth, spriteHeight);
  return t1;
};
...
$.GameKeyboardEvent$fromEvent$5 = function(type, eventPhase, target, currentTarget, event$) {
  var t1 = event$.get$altGraphKey();
  var t2 = event$.get$altKey();
  var t3 = event$.get$ctrlKey();
  var t4 = event$.get$metaKey();
  var t5 = event$.get$shiftKey();
  var t6 = event$.get$keyIdentifier();
  return new $.GameKeyboardEvent(event$.get$keyLocation(), t6, t5, t4, t3, t2, t1, currentTarget, target, eventPhase, type);
};
...
$.Game$1 = function(canvasArg) {
  var t1 = new $.Game(null, null, null, null, null, null, 0, 0, 0, 0, 30, canvasArg.getContext$1('2d'), canvasArg, null, null, null, null, null);
  t1.GameNode$0();
  t1.Game$1(canvasArg);
  return t1;
};
...
$.GameEvent$4 = function(type, eventPhase, target, currentTarget) {
  return new $.GameEvent(currentTarget, target, eventPhase, type);
};
...
$.Xorshift$minmax$2 = function(min, max) {
  return new $.Xorshift(max, min);
};
...
$.main = function() {
  $.game = $.Game$1($.query('#game'));
  $.game.size$2(800, 600);
  $.game.set$fps(15);
  var t1 = ['images/image.png'];
  $.game.set$preloadImages(t1);
  t1 = ['audios/kaiT_newshound_mixed.ogg', 'audios/kaiT_tsukimisou_mixed.ogg', 'audios/zenPRen_areiNoKodomo_mixed.ogg'];
  $.game.set$preloadAudios(t1);
  $.add$1($.game.get$on().get$load(), new $.Closure());
  $.game.start$0();
};
...
$.FirstScene$0 = function() {
  var t1 = new $.FirstScene(null, null, null, null, null, null, null, null, null);
  t1.GameNode$0();
  t1.Scene$0();
  t1.FirstScene$0();
  return t1;
...
$.MainScene$0 = function() {
  var t1 = new $.MainScene(null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null);
  t1.GameNode$0();
  t1.Scene$0();
  t1.MainScene$0();
  return t1;
...
$.ShapeText$4 = function(text, startX, startY, font) {
  var t1 = new $.ShapeText(null, null, font, text, null, startY, startX, null, null, null, null, null, null, null, null, null);
  t1.GameNode$0();
  return t1;
};
...
$.$defineNativeClass('HTMLBaseFontElement', [], {
 size$2: function(arg0, arg1) { return this.size.$call$2(arg0, arg1); },
 is$Element: function() { return true; }
});
...
$.$defineNativeClass('CSSStyleDeclaration', ["length?"], {
 ...
 size$2: function(arg0, arg1) { return this.get$size().$call$2(arg0, arg1); },
 get$left: function() {
 ...
 get$fontSize: function() {
  return this.getPropertyValue$1('font-size');
 },
...
$.$defineNativeClass('CanvasRenderingContext2D', ["textBaseline!", "textAlign!", "strokeStyle!", "lineWidth!", "lineJoin!", "font!", "fillStyle!"], {
 rect$4: function(x, y, width, height) {
  return this.rect(x,y,width,height);
 },
 get$rect: function() { return new $.Closure55(this, 'rect$4'); },
...
$.$defineNativeClass('DocumentFragment', [], {
 ...
 get$click: function() { return new $.Closure53(this, 'click$0'); },
...
$.$defineNativeClass('Element', ["style?", "innerHTML!"], {
 ...
 getComputedStyle$1: function(pseudoElement) {
  var t1 = ({});
  t1.pseudoElement_1 = pseudoElement;
  t1 = new $.Closure40(this, t1);
  var t2 = $.CompleterImpl$0();
  $.setRuntimeTypeInfo(t2, ({T: 'CSSStyleDeclaration'}));
  return $._createMeasurementFuture(t1, t2);
 },
...
$.$defineNativeClass('Event', ["type?", "target?", "eventPhase?"], {
});
...
$.$defineNativeClass('KeyboardEvent', ["shiftKey?", "metaKey?", "keyLocation?", "keyIdentifier?", "ctrlKey?", "altKey?", "altGraphKey?"], {
});
...
$.$defineNativeClass('HTMLMediaElement', ["src!"], {
 ...
 get$load: function() { return new $.Closure53(this, 'load$0'); },
 get$on: function() {
...
$.$defineNativeClass('MouseEvent', ["y?", "x?", "shiftKey?", "metaKey?", "ctrlKey?", "button?", "altKey?"], {
});
...
$.$defineNativeClass('ScriptProfileNode', [], {
 ...
 get$children: function() { return new $.Closure53(this, 'children$0'); }
});
...
$.$defineNativeClass('UIEvent', ["layerY?", "layerX?"], {
});
...
$.$defineNativeClass('WheelEvent', ["y?", "x?", "shiftKey?", "metaKey?", "ctrlKey?", "altKey?"], {
});
